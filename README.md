🏆 League of Legends - Ranked Data Analysis & Dashboard
...
1. Coleta_Partidas.py (Mapeamento da Base de Jogadores):
...
2. Coleta_Players.py (Extração Profunda de Partidas):
...
1. Insira sua chave da API da Riot (RGAPI) nos scripts Python.
2. Execute Coleta_Partidas.py para gerar a base de players.
3. Execute Coleta_Players.py para buscar o detalhamento das partidas.
4. Abra o arquivo .pbix no Power BI Desktop e atualize a fonte de dados para visualizar o dashboard.
